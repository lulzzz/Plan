# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-06-27 14:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dim_customer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimCustomer')),
                ('dim_fabric', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimFabric')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dim_product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimProduct')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dim_location', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimLocation', verbose_name='country')),
            ],
            options={
                'verbose_name': 'Vendor',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dim_product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimProduct')),
                ('dim_product_matching', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='dim_product_matching', to='app_ess.DimProduct')),
                ('dim_season', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimSeason')),
                ('dim_vendor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimVendor')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimProductClass'),
        ),
        migrations.AddField(
            model_name='dimproduct',
            name='dim_product_gender',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimProductGender'),
        ),
        migrations.AddField(
            model_name='dimproduct',
            name='dim_product_keywords',
            field=models.ManyToManyField(to='app_ess.DimProductKeyword', verbose_name='keywords'),
        ),
        migrations.AddField(
            model_name='dimproduct',
            name='dim_product_sizes',
            field=models.ManyToManyField(to='app_ess.DimProductSizeRange', verbose_name='sizes'),
        ),
        migrations.AddField(
            model_name='dimproduct',
            name='dim_product_subclass',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimProductSubclass'),
        ),
        migrations.AddField(
            model_name='dimproduct',
            name='dim_product_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimProductType'),
        ),
        migrations.AddField(
            model_name='dimproduct',
            name='dim_season',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimSeason'),
        ),
        migrations.AddField(
            model_name='dimproduct',
            name='dim_vendor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_ess.DimVendor'),
        ),
        migrations.AddField(
            model_name='dimmaterial',
            name='dim_product',
            field=models.ManyToManyField(to='app_ess.DimProduct'),
        ),
        migrations.AlterUniqueTogether(
            name='dimmaterial',
